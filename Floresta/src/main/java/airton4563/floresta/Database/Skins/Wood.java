...
public class Wood {
    private String database = "floresta_wood";
    ...
    public void create() {
        try {
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                ...
                List<String> lore = Arrays.asList(Machados.WOOD.getLore().split("\\|"));
                ItemStack item = Util.createItem(Machados.WOOD.getMaterial(), Machados.WOOD.getName(), lore);
