...
public class Stone {
    private String database = "floresta_stone";
    ...
    public void create() {
        try {
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                ...
                List<String> lore = Arrays.asList(Machados.STONE.getLore().split("\\|"));

                ItemStack item = Util.createItem(Machados.STONE.getMaterial(), Machados.STONE.getName(), lore);
