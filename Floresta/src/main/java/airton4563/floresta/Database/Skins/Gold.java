...
public class Gold {
    private String database = "floresta_gold";
    ...
    public void create() {
        try {
            ...
            if (rs.next() && rs.getInt(1) == 0) {
                ...
                List<String> lore = Arrays.asList(Machados.GOLD.getLore().split("\\|"));

                ItemStack item = Util.createItem(Machados.GOLD.getMaterial(), Machados.GOLD.getName(), lore);
